namespace IPAGEBiblioteca.Views.ControlView
{
    ...
    public partial class frmEditora : XtraUserControl
    {
        #region Declaracoes
        private readonly IEditoraModels userModels;
        #endregion

        #region Construtores da Classe
        public frmEditora(IEditoraModels userModels)
        {
            InitializeComponent();
        ...
        {
            var userdelete = editoraModelsBindingSource.Current as EditoraModels;
            if (userdelete != null)
            {
        ...
        private void MenuEditar_Click(object sender, System.EventArgs e)
        {
            ...
            {
                using (var forms = new frmEditoraAdd(
                                                     editoraModelsBindingSource.Current as EditoraModels,
        ...
        {
            using (var forms = new frmEditoraAdd(null, 
                                                new EditoraRepository(new BiblioteContext()),
                                                new PaisRepository(new BiblioteContext())))
            {
                var usercontrol = OpenFormsDialog.ShowForm(null, forms);
        ...
        private async void Loader()
        {
            ...
            try
            {
                editoraModelsBindingSource.DataSource = await userModels.GetAll()
                                                                       .Include(x => x.Pais)
                                                                       .ToListAsync();
            }
            finally
