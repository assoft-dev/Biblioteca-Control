namespace IPAGEBiblioteca.Views.ControlView
{
    ...
    public partial class frmInstituicao : XtraUserControl
    {
        #region Declaracoes
        private readonly IInstituicaoModels userModels;
        #endregion

        #region Construtores da Classe
        public frmInstituicao(IInstituicaoModels userModels)
        {
            InitializeComponent();
        ...
        {
            var userdelete = instituicaoModelsBindingSource.Current as InstituicaoModels;
            if (userdelete != null)
            {
        ...
        private void MenuEditar_Click(object sender, System.EventArgs e)
        {
            ...
            {
                using (var forms = new frmInstituicaoAdd(  instituicaoModelsBindingSource.Current as InstituicaoModels,
        ...
        {
            using (var forms = new frmInstituicaoAdd(null,
                                                new InstituicaoRepository(new BiblioteContext())))
            {
                var usercontrol = OpenFormsDialog.ShowForm(null, forms);
                if (usercontrol == DialogResult.OK)
        ...
        private async void Loader()
        {
            ...
            try
            {
                instituicaoModelsBindingSource.DataSource = await userModels.GetAll()
                                                                       .ToListAsync();
            }
            finally
            {
