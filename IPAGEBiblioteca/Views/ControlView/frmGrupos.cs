namespace IPAGEBiblioteca.Views.ControlView
{
    ...
    public partial class frmGrupos : XtraUserControl
    {
        #region Declaracoes
        private readonly IGruposRepository userModels;
        #endregion
        ...
        {
            var userdelete = gruposModelsBindingSource.Current as GruposModels;
            if (userdelete != null)
            {
        ...
        private void MenuEditar_Click(object sender, System.EventArgs e)
        {
            ...
            {
                using (var forms = new frmGruposAdd(
                                                     gruposModelsBindingSource.Current as GruposModels,
        ...
        private async void Loader()
        {
            ...
            try
            {
                gruposModelsBindingSource.DataSource = await userModels.GetAll()
                                                                       .Include(x => x.PermissoesModels)
                                                                       .ToListAsync();
            }
            finally
            {
